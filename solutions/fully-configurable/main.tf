...
module "secret_group" {
  ...
  secret_group_name        = module.iks_base.cluster_id
  secret_group_description = "Secret group for storing ingress certificates for cluster ${var.cluster_name} with id: ${module.iks_base.cluster_id}"
...
module "kube_audit" {
  ...
  cluster_resource_group_id               = module.iks_base.resource_group_id
  region                                  = module.iks_base.region
